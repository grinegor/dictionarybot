...
- `🔁 Повторение FSRS`: обычный режим EN -> RU с обновлением FSRS.
- `🧠 Ассоциации FSRS`: режим RU + ассоциация -> EN с обновлением FSRS.
- `🎲 Повторение рандом`: случайные карточки EN -> RU без влияния на FSRS.
- `🎲 Ассоциации рандом`: случайные карточки RU + ассоциация -> EN без влияния на FSRS.
